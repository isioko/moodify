...
class EntryTabViewController: UIViewController, UICollectionViewDataSource {
...
//            return entryDateString == todayString
    ...
    func performMemoryNotification(){
        let date_formatter = DateFormatter()
        date_formatter.dateFormat = "yyyy/MM/dd"
...
extension EntryTabViewController: UICollectionViewDelegate{
...
extension EntryTabViewController: UISearchControllerDelegate{
